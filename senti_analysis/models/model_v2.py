...
def get_model(learning_rate=config.LEARNING_RATE, name='model_v2'):
    """
    create model.
    :return: model
    """
    ...
    share_hidden = tf.keras.layers.GRU(128, activation='relu', return_sequences=True, reset_after=True)(embedding)
    share_hidden = tf.keras.layers.GRU(64, activation='relu', reset_after=True)(share_hidden)
